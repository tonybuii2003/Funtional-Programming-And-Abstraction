...
public class GeometryTest {
    ...
    private static void testRadialGraphSymmetries() {
        ...
        // obtain all the symmetries (including the identity) of g1, and print them one
        // by one (remember that printing
        // will give the string representation of each radial graph, which must follow
        // the specification of Shape's
        // toString() method)
        List<RadialGraph> symmetries = (List<RadialGraph>) graphSymmetries.symmetriesOf(g1);
        for (RadialGraph g : symmetries)
    ...
    private static void testSquareSymmetries() {
        ...
        boolean tmp = squareSymmetries.areSymmetric(sq1, sq2); // must return false
        System.out.println(tmp);
        tmp = squareSymmetries.areSymmetric(sq1, sq3); // must return true
        System.out.println(tmp);

        // obtain all the 8 symmetries (including the identity) of sq1, and print them
        // one by one (remember that printing
        // will give the string representation of each square, which must follow the
        // specification of Shape's toString()
        // method)
